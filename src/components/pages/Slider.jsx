    ...
    return (
      <div id="slider">
        <div className="slide fade" style={{display: (this.state.slideIndex === 1) ? "block" : "none"}}>
          ...
          <img src="./img/img-13.jpg" className="slider-back" alt="Slider 1"/>
        </div>
